        	...
        	$html .= '<div class="js-partidos" id="'.$cont.'" data-date="'.$key->fecha.'">
	                        ...
	                        <div class="js-partidos__versus">
	                            <div class="js-partido__versus--flag">
	                                <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect js-radio--right js-right" for="option-'.$cont.'">
	                                    ...
	                                    <input type="radio" id="option-'.$cont.'" class="mdl-radio__button" name="options'.$cont.'" value="1" onchange="openModalConfirmar(this.id)" onclick="guardarScore(&#39;'.$key->pais1.'&#39;, &#39; &#39;, '.$cont.')">
	                                </label>
	                            ...
	                            <div class="js-partido__versus--flag">
	                                ...
	                                <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-'.$cont1.'">
	                                    <input type="radio" id="option-'.$cont1.'" class="mdl-radio__button" name="options'.$cont.'" value="1" onchange="openModalConfirmar(this.id)" onclick="guardarScore(&#39;'.$key->pais2.'&#39;, &#39; &#39;, '.$cont.')">
	                        ...
	                        <div class="js-partidos__empate">
	                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-'.$cont2.'">
	                                <input type="radio" id="option-'.$cont2.'" class="mdl-radio__button" name="options'.$cont.'" value="1" onchange="openModalConfirmar(this.id)" onclick="guardarScore(&#39;'.$key->pais2.', '.$key->pais2.'&#39;, &#39;Empate&#39;, '.$cont.')">
